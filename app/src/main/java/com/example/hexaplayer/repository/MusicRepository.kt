...
class MusicRepository(private val context: Context) {
    ...
    /**
     * @param sortOrderIndex  0=Title↑ 1=Title↓ 2=Artist↑ 3=Album↑ 4=Duration↑
     *                        5=Duration↓ 6=DateAdded↓ 7=DateAdded↑
     */
    ...
    /** Returns (subfolderPaths, directSongs) at the given path prefix. */
    ...
    /** Top-level folder paths from all songs. */
